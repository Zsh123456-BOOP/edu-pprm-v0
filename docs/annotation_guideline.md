...
hint_level: low
leakage_constraint: do_not_reveal_final_answer
repair_target: 7 x 2 = 12
reason: The setup is correct; the earliest useful action is to ask the student to recompute the local expression 7 x 2 = 12 before using it in the total.
